...
<div class="container">
	...
	<h2 class="bpg-nino-mtavruli-regular"><?php echo lang('edit_post'); ?></h2>

	<select id="edit-post" class="form-control">
		<option></option>
		<?php foreach($news as $n) { ?>
			<option value="<?php echo $n['id']; ?>"><?php echo $n['ka_title']; ?></option>
		<?php } ?>
	</select>

	<br>

	<h2 class="bpg-nino-mtavruli-regular"><?php echo lang('add_post'); ?></h2>
	...
	<h2 class="bpg-nino-mtavruli-regular"><?php echo lang('delete_post'); ?></h2>
	
	<form class="delete-form" method="post" action="<?php echo base_url('admin/delete_news'); ?>">
		<div class="form-group">
